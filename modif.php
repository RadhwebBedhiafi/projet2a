      ...
      <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="utilities-other.html">Afficher Catégorie</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item active">
        ...
        <div id="collapsePages" class="collapse show" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="404.html">Afficher Produit</a>
            <a class="collapse-item active" href="blank.html">Ajouter Produit Produit</a>
          </div>
        </div>
      </li>
...
if (isset($_POST['modifier'])){
	$produit=new produit($_POST['idP'],$_POST['nomP'],$_POST['quantiteP'],$_POST['description'],$_POST['prix']);
